...
const internationalTours: InternationalTourSeed[] = [
  {
    ...
    tour: {
      ...
      availableSeats: 120,
      imageUrl: IMAGES.bangkokPattaya[0],
      tourType: 'Tour Pho Bien',
      departurePoint: 'TP.HCM hoac Ha Noi',
      highlights: [
