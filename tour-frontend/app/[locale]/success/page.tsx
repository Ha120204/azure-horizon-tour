        ...
        return (
            <div className="bg-surface font-body text-on-surface min-h-screen flex flex-col">
                ...
                <div className="flex-grow flex items-center justify-center pt-20">
                    <p className="font-bold text-primary text-xl">Generating your e-ticket...</p>
                </div>
                <Footer />
            </div>
        );
        ...
        return (
            <div className="bg-surface font-body text-on-surface min-h-screen flex flex-col">
                ...
                <div className="flex-grow flex flex-col items-center justify-center space-y-4 pt-20">
                    <h1 className="text-2xl font-bold text-error">Ticket not found</h1>
            ...
            <main className="flex-grow pt-32 pb-20 px-4 md:px-6 overflow-hidden">
                        ...
                        <div className="md:w-2/3 p-6 md:p-10 flex flex-col md:flex-row gap-8">
                            <div className="flex-grow">
                                <div className="flex justify-between items-start mb-6">
                                    <div>
                                        <p className="text-[10px] font-bold uppercase tracking-[0.15em] text-outline mb-1">Booking Code</p>
                                    ...
                                    <div className="bg-emerald-50 px-3 py-1 rounded-full flex items-center gap-2 border border-emerald-100">
                                        ...
                                        <span className="text-[10px] font-bold text-emerald-700 uppercase">
                                            {ticketData.status === 'CONFIRMED' ? 'Confirmed' : 'Pending'}
                                        </span>
                                    </div>
                                </div>
                                ...
                                <div className="grid grid-cols-1 sm:grid-cols-2 gap-y-6 gap-x-12">
                                    <div className="sm:col-span-2">
                                        <p className="text-[10px] font-bold uppercase tracking-wider text-outline mb-1">Tour Name</p>
                                        <p className="font-headline font-bold text-base md:text-lg leading-tight">
                                            {ticketData.tour?.name || 'Unknown Tour'}
                                        </p>
                                    </div>
                                    <div>
                                        <p className="text-[10px] font-bold uppercase tracking-wider text-outline mb-1">Date & Time</p>
                                        <p className="font-semibold text-sm md:text-base">
                                            {ticketData.tour?.startDate ? new Date(ticketData.tour.startDate).toLocaleString('en-GB', { dateStyle: 'medium', timeStyle: 'short' }) : 'TBA'}
                                        </p>
                                    </div>
                                    <div>
                                        <p className="text-[10px] font-bold uppercase tracking-wider text-outline mb-1">Duration</p>
                                        <p className="font-semibold text-sm md:text-base">
                                    ...
                                    <div>
                                        <p className="text-[10px] font-bold uppercase tracking-wider text-outline mb-1">Passengers</p>
                                        <p className="font-semibold text-sm md:text-base">{ticketData.numberOfPeople} {ticketData.numberOfPeople > 1 ? 'Passengers' : 'Passenger'}</p>
                                    </div>
                                    <div>
                                    ...
                                    <div>
                                        ...
                                        <p className="font-semibold text-sm md:text-base text-primary">
                                            {ticketData.paymentMethod ? `Paid via ${ticketData.paymentMethod}` : (ticketData.paymentStatus === 'PAID' ? 'Online Payment' : 'Unpaid')}
                                        </p>
                                    </div>
                                    <div>
                                        <p className="text-[10px] font-bold uppercase tracking-wider text-outline mb-1">Total Amount</p>
                ...
                <section className="flex flex-col sm:flex-row gap-4 justify-center items-center">
                    ...
                    >
                        ...
                        {isDownloading ? 'Exporting PDF...' : 'Download E-Ticket (PDF)'}
                    </button>
