    ...
    return (
        <div className="flex min-h-screen flex-col bg-surface font-body text-on-surface antialiased">
            <style dangerouslySetInnerHTML={{
                ...
                /* Hero text entrance — runs once on load, no JS needed */
                @keyframes about-hero-up {
                    from { opacity: 0; transform: translateY(24px); }
                    to   { opacity: 1; transform: translateY(0); }
                }
                .about-hero-enter {
                    animation: about-hero-up 0.7s cubic-bezier(0.16, 1, 0.3, 1) both;
                }
                .about-hero-enter-d1 { animation-delay: 80ms; }
                .about-hero-enter-d2 { animation-delay: 180ms; }
                .about-hero-enter-d3 { animation-delay: 280ms; }
                .about-hero-enter-d4 { animation-delay: 380ms; }

                /* Stat cards stagger on desktop (column), on sm row */
                .about-stat-enter {
                    animation: about-hero-up 0.55s cubic-bezier(0.16, 1, 0.3, 1) both;
                }
                .about-stat-d0 { animation-delay: 340ms; }
                .about-stat-d1 { animation-delay: 420ms; }
                .about-stat-d2 { animation-delay: 500ms; }
