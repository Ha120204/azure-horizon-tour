...
export default function HomePage() {
  ...
  // Bắt lỗi thanh toán từ URL
  useEffect(() => {
    const errorParam = searchParams.get('error');
    if (errorParam === 'payment_cancelled' || errorParam === 'payment_failed') {
      setToastTitle(t('checkout.paymentStatus') || 'Trạng thái thanh toán');
      setErrorMsg(
      ...
      // Dọn dẹp URL bằng URLSearchParams để xóa parameter error
