        ...
        <div className="min-h-screen flex items-center justify-center bg-[#f0f4ff] relative overflow-hidden">
            ...
            >
                ...
                <div className="flex items-center gap-4 mt-5">
                    ...
                    <span className="text-[11px] font-semibold text-[#94a3b8] tracking-[0.08em]">HOẶC</span>
                    <div className="flex-1 h-px bg-black/[0.08]" />
                </div>
                ...
                <button
                    ...
                    className="mt-4 w-full flex items-center justify-center gap-3 py-[13px] px-5 rounded-[14px] bg-white border border-[#dadce0] text-[#3c4043] text-[14px] font-semibold cursor-pointer transition-all duration-200 hover:bg-[#f8f9fa] hover:shadow-sm disabled:opacity-60 disabled:cursor-not-allowed"
                >
                    {isGoogleLoading ? (
                        <span className="material-symbols-outlined animate-spin text-[20px] text-[#94a3b8]">progress_activity</span>
                    ) : (
