...
const EMPTY_HIGHLIGHT: TourHighlightForm = {
  content: "",
  contentEn: "",
  icon: "auto_awesome",
};
const EMPTY_FAQ: TourFaqForm = {
  question: "",
  questionEn: "",
  answer: "",
  answerEn: "",
...
type TourFormErrors = Partial<Record<keyof TourFormData, string>>;
...
export default function TourFormModal({
  ...
  const applyFaqTemplate = (
    idx: number,
    template: (typeof FAQ_TEMPLATES)[number],
  ) => {
    updateFaq(idx, {
    ...
    setDepartures((prev) =>
      prev.map((departure, index) => {
        ...
        return item
          ? {
              ...departure,
              noteEn: item.noteEn?.trim() || departure.noteEn,
            }
          : departure;
      }),
    );
  ...
  const handleSave = async (action: "draft" | "submit") => {
    ...
    try {
      ...
      if (tourId) {
        ...
        const departureResult = await departureResponse
          .json()
          .catch(() => null);
                ...
                <div className="space-y-4 bg-surface-container-low/40 rounded-2xl p-4 sm:p-5 border border-outline-variant/10">
                  ...
                  <div>
                    ...
                    <p className={helperTextClass}>
                      Nên có điểm đến, loại trải nghiệm và điểm nổi bật. Ví dụ:
                      Hạ Long: Du thuyền 5 sao kèm ăn trưa.
                    </p>
                    {errors.name && (
                  ...
                  <div>
                    ...
                    <p className={helperTextClass}>
                      Viết 2-4 câu: khách sẽ đi đâu, trải nghiệm gì, tour phù
                      hợp với ai.
                    </p>
                    {errors.description && (
                      <p className="text-error text-xs mt-1 flex items-center gap-1">
                        ...
                        <span id="field-description-error">
                          {errors.description}
                        </span>
                      </p>
                    )}
              ...
              <div id="tour-section-pricing" className="scroll-mt-6">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 bg-surface-container-low/40 rounded-2xl p-4 sm:p-5 border border-outline-variant/10">
                  ...
                  <div>
                    ...
                    <div className="relative">
                      ...
                      <input
                        ...
                        aria-describedby={
                          errors.price ? "field-price-error" : undefined
                        }
                        inputMode="numeric"
                        autoComplete="off"
                    ...
                    <p className={helperTextClass}>
                      Giá cơ bản mỗi khách. Ngày khởi hành hoặc gói tour có thể
                      có giá riêng.
                    </p>
                    {errors.price && (
                      <p className="text-error text-xs mt-1 flex items-center gap-1">
                  ...
                  <div>
                    ...
                    <p className={helperTextClass}>
                      Dùng làm sức chứa mặc định nếu ngày khởi hành chưa đặt số
                      ghế riêng.
                    </p>
                    {errors.availableSeats && (
                      <p className="text-error text-xs mt-1 flex items-center gap-1">
              ...
              >
                ...
                <div className="space-y-3">
                  ...
                  <button
                    type="button"
                    onClick={() => {
                      setDepartures((d) => [...d, createEmptyDeparture()]);
                      setErrors((prev) => ({
                        ...prev,
                        startDate: undefined,
                      }));
                    ...
                    >
                      ...
                      <div className={bilingualGridClass}>
                        <div>
                          ...
                          />
                          <p className={helperTextClass}>
                            Nên chọn 3-6 hoạt động chính, tránh nhập quá dài như
                            mô tả ngày.
                          </p>
                        </div>
                        <div className={englishFieldClass}>
                          ...
                          />
                          <p className={helperTextClass}>
                            Giữ tương ứng với danh sách tiếng Việt để bản dịch
                            rõ ràng.
                          </p>
                        </div>
                      </div>
                      ...
                      <div className={bilingualGridClass}>
                        <div>
                          ...
                          <p className={helperTextClass}>
                            Nên nhập theo thứ tự diễn ra trong ngày, ví dụ 07:30
                            - Đón khách.
                          </p>
                        </div>
                        <div className={englishFieldClass}>
                          ...
                          <p className={helperTextClass}>
                            Giữ cùng khung giờ với timeline tiếng Việt để khách
                            dễ đối chiếu.
                          </p>
                        </div>
                      </div>
