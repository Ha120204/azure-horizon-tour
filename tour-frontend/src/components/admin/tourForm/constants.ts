...
export const toUiDepartureCategory = (category?: string | null): SaleCategory => {
...
export const DEPARTURE_POINTS = [
    ...
    'Nha Trang', 'Đà Lạt', 'Huế', 'Vũng Tàu', 'Quy Nhơn', 'Phú Quốc', 'Hội An',
];

export const PACKAGE_NAMES = [
    'Gói Tiêu Chuẩn', 'Gói Cao Cấp', 'Gói Luxury',
    'Gói Gia Đình', 'Gói Cặp Đôi', 'Gói Quà Tặng', 'Gói Nhóm',
];
