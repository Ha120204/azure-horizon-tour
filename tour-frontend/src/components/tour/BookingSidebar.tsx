...
function TransportSummaryCard({
  ...
  formatDate: (v: string | number | Date, opts?: Intl.DateTimeFormatOptions) => string;
  language: string;
}) {
            ...
            <div className="sticky top-28 bg-white rounded-3xl shadow-xl border border-outline-variant/10 overflow-hidden">
                ...
                <div className="p-5 space-y-5">
                    ...
                    {selectedDeparture?.transport && selectedDeparture.transport.type !== 'SELF_ARRANGED' && (
                        <TransportSummaryCard transport={selectedDeparture.transport} formatDate={formatDate} language={language} />
                    )}
